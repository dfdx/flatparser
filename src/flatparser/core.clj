...
(def feat-order
  [:price :price_square_meter :monthly_fee :clazz :room_no :size_t :size_l :size_k :dist_to_subway :dist_to_kp :state :beds :furniture :district :subway :floor :floors :year_built :walls :date :address :lat :lon :url ])
